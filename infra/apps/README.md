...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_s3sentinel"></a> [s3sentinel](#module\_s3sentinel) | ../../modules/s3sentinel | n/a |
...
| <a name="input_resource_prefix"></a> [resource\_prefix](#resource\_prefix) | A prefix to use for naming resources. | `string` | `"dp-demo-stack"` | no |
| <a name="input_s3sentinel_backend_access_key"></a> [s3sentinel\_backend\_access\_key](#input\_s3sentinel\_backend\_access\_key) | Access key for the S3 backend used by s3sentinel. | `string` | n/a | yes |
| <a name="input_s3sentinel_backend_secret_key"></a> [s3sentinel\_backend\_secret\_key](#input\_s3sentinel\_backend\_secret\_key) | Secret key for the S3 backend used by s3sentinel. | `string` | n/a | yes |
